...
/** Complete Turkey district data: 81 provinces, 991 districts. Last verified 2026-05-16. */
export const TURKEY_DISTRICTS: Record<string, District[]> = {
  ...
  mersin: [
    ...
    { name: "Bozyazı",       slug: "bozyazi" },
    { name: "Çamlıyayla",    slug: "camliyayla" },
    { name: "Erdemli",       slug: "erdemli" },
    { name: "Gülnar",        slug: "gulnar" },
  ...
  konya: [
    ...
    { name: "Tuzlukçu",      slug: "tuzlukcu" },
    { name: "Yalıhüyük",     slug: "yalihuyuk" },
  ...
  trabzon: [
    ...
    { name: "Dernekpazarı",  slug: "dernekpazari" },
  ...
  aksaray: [
    ...
    { name: "Sultanhani",    slug: "sultanhani" },
  ],
  bayburt: [
    { name: "Merkez",        slug: "merkez" },
