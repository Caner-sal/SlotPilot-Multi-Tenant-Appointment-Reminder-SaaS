...
> Bu doküman Randevo'un WhatsApp Auto Booking Link Reply modülü için geçerlidir.
...
- Şu aşamada Randevo pencere dışı otomatik mesaj göndermez.
...
Örnek:
```
https://randevo.com/booking/berber-demo
```
